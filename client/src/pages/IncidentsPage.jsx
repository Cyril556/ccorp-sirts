...
import { MOCK_INCIDENTS, getUserById } from '../data/mockData.js';
      ...
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-0.5">{filtered.length} of {MOCK_INCIDENTS.length} incidents</p>
          </div>
              ...
              {filtered.map((inc, idx) => {
                ...
                return (
                  <tr key={inc.id} onClick={()=>navigate(`/incidents/${inc.id}`)} className="hover:bg-gray-800/50 cursor-pointer transition-colors">
                    ...
                    <td className="px-5 py-4 hidden lg:table-cell text-gray-400 text-xs">{assignee?.name || <span className="text-gray-600 italic">Unassigned</span>}</td>
